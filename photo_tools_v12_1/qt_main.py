...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("PhotoTools V12.1 — 摄影素材管理工具箱")
    ...
    def _build_menus(self):
        ...
        about_act = QAction("关于 PhotoTools V12.1", self)
    ...
    def _show_about(self):
        ...
        QMessageBox.about(
            self,
            "关于 PhotoTools V12.1",
            "PhotoTools V12.1 摄影素材管理工具箱\n\n"
            "AI 图像增强 · 模块化流水线（几何校正 / 调色增强 / 构图裁剪）")
