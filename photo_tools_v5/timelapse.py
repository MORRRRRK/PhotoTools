...
def _save_scaled(img: Image.Image, out_size: tuple, dest: Path):
    ...
    canvas.save(dest, "JPEG", quality=98)
...
def generate_timelapse(
    ...
    try:
        ...
        for idx, fp in enumerate(files, 1):
            ...
            dest = frame_dir / f"frame_{idx:06d}.jpg"
            if stabilize:
                img.save(dest, "JPEG", quality=98)
            else:
        ...
        if stabilize:
            ...
            detect_cmd = [
                ...
                "-vf", "vidstabdetect=result=transforms.trf:shakiness=5:accuracy=15:stepsize=6:mincontrast=0.3",
                "-f", "null", "NUL",
            ...
            vf = (
                "vidstabtransform=input=transforms.trf:zoom=1:optzoom=1:smoothing="
                f"{smooth},"
        ...
        encode_cmd += [
            ...
            "-crf", str(crf), "-preset", "veryfast", "-movflags", "+faststart",
