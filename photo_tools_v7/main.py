...
class PhotoToolsApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("PhotoTools V7.0 — 摄影素材管理工具箱")
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(ab, text="关于 PhotoTools V7.0", font=("", 14, "bold")).pack(anchor="w", pady=5)
        ctk.CTkLabel(ab, text="版本 7.0.0 | 摄影素材管理工具箱").pack(anchor="w")
    ...
    def _t1_preview(self,fp):
        from photo_tools_v7.preview import load_image
