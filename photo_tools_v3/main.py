...
def load_config() -> dict:
    cfg = {"pushplus_token": "",
           "max_workers": 4,
        "font_scale": 1.0,
        "font_scale": 1.0, "appearance": "system"}
...
class PhotoToolsApp(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(ab, text="版本 2.3.0 | 摄影素材管理工具箱").pack(anchor="w")
    ...
    def _t1_preview(self,fp):
        from photo_tools_v3.preview import load_image
