"""qt_main.py - V11.0 主窗口：可折叠侧边栏 + 中央堆叠页面"""
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("PhotoTools V11.0 — 摄影素材管理工具箱")
    ...
    def _build_menus(self):
        ...
        about_act = QAction("关于 PhotoTools V11.0", self)
    ...
    def _show_about(self):
        ...
        QMessageBox.about(
            self,
            "关于 PhotoTools V11.0",
            "PhotoTools V11.0 摄影素材管理工具箱\n\n"
            "专业摄影工作站风格 · 可折叠侧边栏 · 重设计照片质量评估页")
